...
if ( ! class_exists( 'ACF_To_REST_API' ) ) {
	...
	class ACF_To_REST_API {
		...
		public static function is_plugin_installed( $plugin ) {
			...
			if ( 'rest-api' == $plugin ) {
				...
				$paths = array( 'advanced-custom-fields-pro/acf.php', 'acf-pro/acf.php', 'advanced-custom-fields/acf.php', 'dashboard-wp/3rd-party/acf/acf.php' );
			}
	...
	add_action( 'plugins_loaded', array( 'ACF_To_REST_API', 'init' ), 999 );
