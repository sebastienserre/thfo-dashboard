		...
		acf_add_local_field_group(array(
			...
			'fields' => array(
				...
				array(
					...
					'sub_fields' => array(
						array(
							...
							'choices' => array(
								0 => __('None', 'dashboard-wp'),
								1 => __('Twitter', 'dashboard-wp'),
								2 => __('Facebook', 'dashboard-wp'),
								3 => __('Linkedin', 'dashboard-wp'),
								4 => __('WordPress', 'dashboard-wp'),
								5 => __('Mail', 'dashboard-wp'),
							),
							'default_value' => array(
							),
							'allow_null' => 0,
				...
				array(
					...
					'choices' => array(
						'posts' => __('posts', 'dashboard-wp'),
						'pages' => __('pages', 'dashboard-wp'),
						'media' => __('media', 'dashboard-wp'),
						0 => __('alert', 'dashboard-wp'),
					),
					'allow_custom' => 0,
					'default_value' => array(
					),
